...
Missing or unreadable enrollment state fails closed for protected administrative
actions while the active-local setup allowlist remains available. The rule precedes regular
